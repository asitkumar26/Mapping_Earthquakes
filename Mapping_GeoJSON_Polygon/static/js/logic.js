...
/* L.geoJson(sanFranAirport, {
    ...
    pointToLayer: function(feature, latlng) {
      ...
      return L.marker(latlng).bindPopup("<h2>" + feature.properties.city + "</h2>" +
         "<br><h3>" + feature.properties.city +"," + feature.properties.country +"</h3>");
    }
...
satelliteStreets = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v11/tiles/{z}/{x}/{y}?access_token={accessToken}', {
  attribution: 'Map data © <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery (c) <a href="https://www.mapbox.com/">Mapbox</a>',
      maxZoom: 18,
      accessToken: API_KEY
  });
